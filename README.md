...
本 README 对应南雍知课 v1.1.7。

当前本地开发分支同时记录尚未发布的 v1.2.0 功能；下载链接仍指向稳定版 v1.1.7。
...
- 五育系统（v1.2.0 本地开发版）：只读展示五维活动对比、成长模块、劳育时长和学期评价，支持活动搜索、筛选、排序、详情弹层及矢量劳动教育学习导引图。
- 第二课堂（v1.2.0 本地开发版）：只读展示参加活动数、服务总时长、不诚信记录和个人资料。上游没有稳定返回报名通过率与完成率，因此页面不会推算或虚构这两项数据。
...
- `v1.2.0`：五育总览、详细活动记录和劳动教育导引图已在本地开发版实现；第二课堂已接通真实个人资料、活动数、服务时长与不诚信记录，并保持轻量只读。
