...
createRoot(document.getElementById('root')!).render(
  <StrictMode>
    ...
    <div className="preview-badge" role="status">
      <strong>交互预览</strong>
      <span>个人数据已脱敏</span>
      <a href="https://github.com/Eurus07e/nanyong-zhike-app/releases/tag/v3.0">下载 v3.0</a>
    </div>
  </StrictMode>,
)

function seedPreviewStorage() {
  if (!window.localStorage.getItem('nanyong-preview-initialized:v3.0')) {
    ...
    window.localStorage.setItem('nanyong-preview-initialized:v3.0', 'true')
  }
}
