    ...
    <div className="about-copy">
      ...
      <section className="about-copy-section">
        ...
        <div className="privacy-points">
          ...
          <article><strong>五育数据</strong><p>五育数据按需从南京大学五育系统查询，仅在浏览器内存中短期缓存，用于展示当前总览；不会写入本站数据库，也不会由本站修改五育系统中的兴趣、评价或活动记录。</p></article>
          <article><strong>第二课堂数据</strong><p>第二课堂个人资料与志愿服务统计按需从南京大学学生第二课堂查询，仅在浏览器内存中短期缓存，不写入本站数据库，也不会由本站修改第二课堂资料或活动记录。学校系统认证过程中存在同域 HTTP 兼容跳转，本站仅允许该固定校园主机参与跳转。</p></article>
