    ...
    <div className="about-copy">
      ...
      <section className="about-copy-section">
        ...
        <div className="privacy-points">
          ...
          <article><strong>五育数据</strong><p>五育数据按需从南京大学五育系统查询。为先显示上次结果并在后台刷新，服务端会按学号保存最近一次五育总览和活动记录的加密快照；浏览器仅在当前会话内存中使用这些数据。本站不会修改五育系统中的兴趣、评价或活动记录。</p></article>
          <article><strong>第二课堂数据</strong><p>第二课堂个人资料与志愿服务统计按需从南京大学学生第二课堂查询。服务端会按学号保存最近一次第二课堂数据的加密快照，用于启动展示与后台刷新；浏览器不会持久保存。本站不会修改第二课堂资料或活动记录。学校系统认证过程中存在同域 HTTP 兼容跳转，本站仅允许该固定校园主机参与跳转。</p></article>
